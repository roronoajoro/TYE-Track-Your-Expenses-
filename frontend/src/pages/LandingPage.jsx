  ...
  return (
    <div className="lp">
      ...
      <nav className="lp-nav" ref={navRef}>
        <div className="lp-logo">Taka Gelo Koi<span>.</span></div>
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          <div className="lp-hero-content">
            ...
            <p className="lp-sub">Taka Gelo Koi transforms how you see your spending. Beautiful dashboards, intelligent budgets, income tracking, and real insights — all in one place.</p>
            ...
            <div className="card3d">
              ...
              <div className="card3d-main">
                <div className="c3-header">
                  ...
                  <span className="c3-title">Taka Gelo Koi Dashboard</span>
                </div>
                <div className="c3-body">
                  <div className="c3-top">
                    <div>
                      <div className="c3-bal-lbl">Total Spent — April</div>
        ...
        <div className="lp-sec-inner">
          ...
          <div className="feat-grid">
            {[
              ...
              ["💸","#2dd4bf","02","Income Tracking","Log your salary, gifts, and donations. See exactly how much you earned vs spent each month.","New","rgba(45,212,191,.1)","var(--teal)","rgba(45,212,191,.2)"],
              ["📊","#7c6af7","03","Visual Analytics","Beautiful charts reveal your spending patterns instantly. Pie charts, bar graphs, monthly trends.","Insights","rgba(124,106,247,.1)","var(--violet)","rgba(124,106,247,.2)"],
              ["🎯","#ff6b6b","04","Smart Budget Alerts","Set monthly limits per category. Get warned before you overspend — not after.","Smart","rgba(255,107,107,.1)","var(--red)","rgba(255,107,107,.2)"],
              ["💰","#4ade80","05","Savings Goals & Pool","Set financial targets. Allocate savings to goals or carry them forward month to month.","Goals","rgba(74,222,128,.1)","var(--green)","rgba(74,222,128,.2)"],
              ["🔐","#e8b84b","06","Google Sign-In","One-click login. Your data is tied to your Google account — private and always accessible.","Secure","rgba(232,184,75,.1)","var(--gold)","rgba(232,184,75,.2)"],
        ...
        <div className="lp-sec-inner">
          ...
          <div className="how-grid">
            <div className="how-steps">
              {[["01","Sign in with Google","One tap. No forms, no passwords. Your Google account creates your profile instantly."],
                ["02","Log income & expenses","Add salary, gifts, or expense amounts — pick a category, set a date, done in seconds."],
                ["03","Set budgets and goals","Set monthly spending limits and create savings goals. Track progress automatically."],
                ["04","Watch your insights grow","The more you log, the smarter your dashboard gets. Monthly trends, goal progress, savings."]
              ].map(([n,t,d]) => (
            ...
            <div className="how-visual anim">
              <div className="how-screen">
                <div className="how-screen-hdr">
                  ...
                  <span style={{marginLeft:"auto",marginRight:"auto",fontSize:".55rem",color:"var(--white3)"}}>Recent Transactions</span>
                </div>
                <div className="how-screen-body">
                  {[["🍜","rgba(249,115,22,.15)","Lunch — Bashundhara","2026-04-14","৳420"],
                    ["🚌","rgba(59,130,246,.15)","Uber to office","2026-04-13","৳250"],
                    ["🛍️","rgba(168,85,247,.15)","Clothing — Aarong","2026-04-12","৳2,800"],
                    ["⚡","rgba(232,184,75,.15)","Electricity Bill","2026-04-10","৳950"],
                    ["🎬","rgba(45,212,191,.15)","Netflix Subscription","2026-04-08","৳400"],
      ...
      <section className="lp-reviews" id="reviews">
        <div className="lp-sec-inner">
          ...
          <div className="reviews-grid">
            {[["R","var(--gold)","Rafi Ahmed","Freelance Designer, Dhaka","I never realized how much I was spending on food delivery until Taka Gelo Koi showed me the monthly breakdown. Changed my habits completely."],
              ...
              ["K","var(--teal)","Karim Hossain","Small Business Owner","Clean, fast, and actually useful. I've tried Mint, Wallet, and five other apps. Taka Gelo Koi is the first one I've stuck with for more than a week."],
      ...
      <section className="lp-cta">
        ...
        <div className="lp-sec-inner" style={{textAlign:"center",position:"relative"}}>
          ...
          <button className="btn-hero-primary" style={{fontSize:"1rem",padding:"1.1rem 2.8rem"}} onClick={onGetStarted}>Open Taka Gelo Koi Free →</button>
        </div>
      </section>

      <footer className="lp-footer">
        <div className="footer-logo">Taka Gelo Koi<span>.</span></div>
        <p style={{fontSize:".72rem",color:"var(--white3)"}}>© 2026 Taka Gelo Koi. Made with care.</p>
