...
const GOOGLE_CLIENT_ID = "114576452021-8e52ima3s04sk72it2emvdic9a7d3006.apps.googleusercontent.com";
...
export default function LoginPage({ onLogin, onBack }) {
  ...
  async function handleGoogleSuccess(credentialResponse) {
    ...
    setError("");
    try {
      // Call backend to verify token and upsert user in DB → returns real user.id
      const res = await axios.post(`${API}/auth/google`, {
        token: credentialResponse.credential,
      });
      onLogin(res.data); // { id, name, email, picture }
    } catch (e) {
    ...
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      <div className="ll-page">
        ...
        <div className="ll-left">
          ...
          <button className="ll-logo-btn" onClick={onBack}>TYE<span>.</span></button>
          ...
          <div className="ll-left-content">
            ...
            <div className="ll-metrics">
              {[["1k+","Active users"],["৳2M+","Tracked monthly"],["Free","No credit card"]].map(([v,l]) => (
                <div key={l} className="ll-metric"><div className="ll-metric-val">{v}</div><div className="ll-metric-lbl">{l}</div></div>
              ))}
            </div>
          </div>
          ...
          <div className="ll-3d-scene">
            <div className="ll-float-card ll-fc1">
              ...
              <div><div className="ll-fc-title">Monthly Report</div><div className="ll-fc-sub">March 2026</div></div>
          ...
          <div className="ll-quote">
            <p>"TYE completely changed how I think about money. Impossible to ignore where your spending goes."</p>
        ...
        <div className="ll-right">
          <div className="ll-form">
            ...
            <div className="ll-form-title">Welcome to TYE</div>
            ...
            <div className="ll-terms">
              By continuing, you agree to TYE's <a href="#">Terms</a> and <a href="#">Privacy Policy</a>.
            </div>
          </div>
        </div>
